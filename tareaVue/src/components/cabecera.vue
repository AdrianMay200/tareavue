    ...
    <div class="bg-[#8ECAE6] text-[#023047] text-3xl md:text-4xl px-10 py-5 md:flex md:justify-between">
      <div class="mb-10" id="header">
        ...
        <div id="subtle" class="ml-5 md:ml-10" style="opacity: 1; transform: translate(0px, 0px);">
          ...
          <p class="text-xl md:text-4xl flex items-baseline gap-2">
            <img src="" alt="email" class="w-6 h-6">
            <span>contacto@isclab.com.mx</span>
          </p>
        </div>
      </div>
    <div id="extwaiokist" style="display:none" v="fcoon" q="a040a1a2" c="652.2" i="660" u="5.294" s="02152317" d="1" w="false" e="}" a="2" m="BMe=" vn="3gtra"><div id="extwaigglbit" style="display:none" v="fcoon" q="a040a1a2" c="652.2" i="660" u="5.294" s="02152317" d="1" w="false" e="}" a="2" m="BMe="></div></div></div>
